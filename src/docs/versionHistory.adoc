...
** Added builtin version of cascade constraint until it's updated.
** Updated the ErrorHandler anotation, found an issue when applying it at a class level, so now it ignores methods that start with $
* 3.0.3
